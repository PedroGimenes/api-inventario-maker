...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Jun-2026 às 20:34
...
--
CREATE DATABASE IF NOT EXISTS `inova_inventario` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `inova_inventario`;
